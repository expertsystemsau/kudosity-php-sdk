...
3. **Does inbound MMS need separate provisioning on `61491570022`?** Outbound MMS works and inbound SMS works, but two picture replies produced no `MMS_INBOUND` at all with a verified-reachable endpoint.
